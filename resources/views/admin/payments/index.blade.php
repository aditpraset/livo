    ...
    <div class="col-12">
        <div class="mb-4 d-flex justify-content-between align-items-center">
            ...
            <div class="d-flex gap-2">
                ...
                <button type="button" class="btn btn-outline-success" id="btn-import">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Import Data Pembayaran dari Excel</h5>
            ...
            <div class="modal-body">
                <div class="alert alert-info small d-flex align-items-start gap-2">
                    ...
                    <div>
                        Gunakan <a href="{{ route('admin.payments.template') }}" class="fw-semibold">template Excel</a> yang disediakan.
                        Isi <strong>ID Siswa</strong> sesuai sheet <em>Master Siswa</em>, serta <strong>Kategori</strong> &amp;
                        <strong>Metode</strong> sesuai sheet <em>Kategori Pembayaran</em> / <em>Metode Pembayaran</em>.
                        No. Pembayaran dibuat otomatis. Baris header tidak diimport.
                    </div>
                </div>
                <div class="mb-2">
...
$(document).ready(function() {
    ...
    $('#btn-upload').on('click', function () {
        ...
        $.ajax({
            url: '{{ route('admin.payments.import') }}', type: 'POST',
            data: formData, processData: false, contentType: false,
            success: function (res) {
                $('#modal-import').modal('hide');
                table.ajax.reload();
                var icon = (res.errors && res.errors.length) ? 'warning' : 'success';
                Swal.fire({ icon: icon, title: 'Selesai', text: res.message, timer: 2800, showConfirmButton: false });
            },
            error: function (xhr) {
