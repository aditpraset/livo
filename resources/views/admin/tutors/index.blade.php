        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" id="field-specialization" class="form-control" placeholder="cth: Matematika, Fisika, Kimia">
                    <div class="form-text">Pisahkan dengan koma jika lebih dari satu mata pelajaran.</div>
                    <div class="invalid-feedback" id="err-specialization"></div>
                </div>
            </div>
...
$(function () {
    ...
    function resetModal() {
        $('#tutor-id, #field-name, #field-phone, #field-specialization').val('');
        $('#field-name, #field-phone, #field-specialization').removeClass('is-invalid');
        $('#err-name, #err-phone, #err-specialization').text('');
    }
    ...
    $(document).on('click', '.btn-edit', function () {
        ...
        $('#tutor-id').val($(this).data('id'));
        $('#field-name').val($(this).data('name'));
        $('#field-phone').val($(this).data('phone'));
        $('#field-specialization').val($(this).data('specialization'));
        $('#modal-tutor').modal('show');
    });
    ...
    $('#btn-save').on('click', function () {
        ...
        $.ajax({
            ...
            data: {
                ...
                specialization: $('#field-specialization').val(),
                _token:         '{{ csrf_token() }}'
            },
